    ...
    <div class="card columns extend-card">
      <div class="column is-8">
        ...
        <div class="column">
          ...
          <div class="has-text-danger is-size-7">
            Ps. The file size limit is 10 MB. And only PDF is supported.<br> Ps2. Please include yourself in the participant list.
          </div>
        </div>
      </div>
      <div class="column is-paddingless has-left-border is-4">
        <div class="padding">
          ...
          <br>
          <div v-for="reflex of storedDes" :key="reflex.key">
            {{ reflex }}
          </div>
          <br>
